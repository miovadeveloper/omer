...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.hastalar.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.hastalars.store") }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-sm-12"> <h3>Hasta Genel Bilgiler
            ...
            <hr>
            <div class="form-group col-sm-4 {{ $errors->has('hasta_kategorisi_id') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4 {{ $errors->has('adi_soyadi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('tc_kimlik_no') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('ilk_gelis_tarihi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('dogum_tarihi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('gsm') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('e_posta') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-12{{ $errors->has('hasta_genel') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Hasta Detay Bilgiler
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('meslek') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('dogum_yeri') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('kan_grubu') ? 'has-error' : '' }}">
                ...
                <select id="kan_grubu" name="kan_grubu" class="form-control">
                    ...
                    @foreach(App\Hastalar::KAN_GRUBU_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('kan_grubu', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('referans') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('sosyal_guvence') ? 'has-error' : '' }}">
                ...
                <select id="sosyal_guvence" name="sosyal_guvence" class="form-control">
                    ...
                    @foreach(App\Hastalar::SOSYAL_GUVENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sosyal_guvence', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('ozel_sigorta') ? 'has-error' : '' }}">
                ...
                <select id="ozel_sigorta" name="ozel_sigorta" class="form-control">
                    ...
                    @foreach(App\Hastalar::OZEL_SIGORTA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ozel_sigorta', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('medeni_durum') ? 'has-error' : '' }}">
                ...
                <select id="medeni_durum" name="medeni_durum" class="form-control">
                    ...
                    @foreach(App\Hastalar::MEDENI_DURUM_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('medeni_durum', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('adres') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('sehir') ? 'has-error' : '' }}">
                ...
                <select id="sehir" name="sehir" class="form-control">
                    ...
                    @foreach(App\Hastalar::SEHIR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sehir', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sehir'))
                    <em class="invalid-feedback">
            ...
            <div class="col-sm-12"> <h3>Eşinin Bilgileri
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('esinin_adi_soyadi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_dogum_tarihi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_dogum_yeri') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_meslegi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_kan_grubu') ? 'has-error' : '' }}">
                ...
                <select id="esinin_kan_grubu" name="esinin_kan_grubu" class="form-control">
                    ...
                    @foreach(App\Hastalar::ESININ_KAN_GRUBU_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('esinin_kan_grubu', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_sosyal_guvence') ? 'has-error' : '' }}">
                ...
                <select id="esinin_sosyal_guvence" name="esinin_sosyal_guvence" class="form-control">
                    ...
                    @foreach(App\Hastalar::ESININ_SOSYAL_GUVENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('esinin_sosyal_guvence', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_telefonu') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_eposta') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-12{{ $errors->has('hasta_cocuk') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Özgeçmiş Bilgileri
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('virgo') ? 'has-error' : '' }}">
                <label>{{ trans('cruds.hastalar.fields.virgo') }}</label>
                @foreach(App\Hastalar::VIRGO_RADIO as $key => $label)
                    <div>
                        <input id="virgo_{{ $key }}" name="virgo" type="radio" value="{{ $key }}" {{ old('virgo', null) === (string)$key ? 'checked' : '' }}>
            ...
            <div class="form-group col-sm-4{{ $errors->has('pms') ? 'has-error' : '' }}">
                <label>{{ trans('cruds.hastalar.fields.pms') }}</label>
                @foreach(App\Hastalar::PMS_RADIO as $key => $label)
                    <div>
                        <input id="pms_{{ $key }}" name="pms" type="radio" value="{{ $key }}" {{ old('pms', null) === (string)$key ? 'checked' : '' }}>
            ...
            <div class="form-group col-sm-4{{ $errors->has('dismenore') ? 'has-error' : '' }}">
                <label>{{ trans('cruds.hastalar.fields.dismenore') }}</label>
                @foreach(App\Hastalar::DISMENORE_RADIO as $key => $label)
                    <div>
                        <input id="dismenore_{{ $key }}" name="dismenore" type="radio" value="{{ $key }}" {{ old('dismenore', null) === (string)$key ? 'checked' : '' }}>
            ...
            <div class="form-group col-sm-4{{ $errors->has('akraba_evliligi') ? 'has-error' : '' }}">
                <label>{{ trans('cruds.hastalar.fields.akraba_evliligi') }}</label>
                @foreach(App\Hastalar::AKRABA_EVLILIGI_RADIO as $key => $label)
                    <div>
                        <input id="akraba_evliligi_{{ $key }}" name="akraba_evliligi" type="radio" value="{{ $key }}" {{ old('akraba_evliligi', null) === (string)$key ? 'checked' : '' }}>
            ...
            <div class="form-group col-sm-4{{ $errors->has('derecesi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('jinekolojik_anomali') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Özgeçmiş Siklus Düzeni
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('menars_yasi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('gun') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('sure') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('miktar') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Özgeçmiş Gebelik Özeti
            </h3></div>
            <hr>
            <div class="form-group col-sm-4{{ $errors->has('gebelik') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('dogum') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('dusuk') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('kurtaj') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('yasayan') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('dis_gebelik') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Özgeçmiş Detayları ve Alışkanlıklar
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('hastaliklar') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('operasyonlar') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('allerji') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('alkol') ? 'has-error' : '' }}">
                ...
                <select id="alkol" name="alkol" class="form-control">
                    ...
                    @foreach(App\Hastalar::ALKOL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('alkol', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('alkol'))
                    <em class="invalid-feedback">
            ...
            <div class="form-group col-sm-4{{ $errors->has('sigara') ? 'has-error' : '' }}">
                ...
                <select id="sigara" name="sigara" class="form-control">
                    ...
                    @foreach(App\Hastalar::SIGARA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sigara', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('ilaclar') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('ozgecmis_ve_soygecmis_notlari') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('uyarilar') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Eşinin Özgeçmiş Detayları ve Alışkanlıkları
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('esinin_hastaliklar') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_operasyonlar') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_allerjileri') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_alkol_kullanimi') ? 'has-error' : '' }}">
                ...
                <select id="esinin_alkol_kullanimi" name="esinin_alkol_kullanimi" class="form-control">
                    ...
                    @foreach(App\Hastalar::ESININ_ALKOL_KULLANIMI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('esinin_alkol_kullanimi', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_sigara_kullanimi') ? 'has-error' : '' }}">
                ...
                <select id="esinin_sigara_kullanimi" name="esinin_sigara_kullanimi" class="form-control">
                    ...
                    @foreach(App\Hastalar::ESININ_SIGARA_KULLANIMI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('esinin_sigara_kullanimi', null) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-4{{ $errors->has('esinin_ozgecmis_ve_soygecmis_notlari') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12"> <h3>Hasta Faturalama Bilgileri
                <hr></h3></div>
            <div class="form-group col-sm-4{{ $errors->has('unvan') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('vergi_dairesi') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('vergi_no') ? 'has-error' : '' }}">
            ...
            <div class="form-group col-sm-4{{ $errors->has('fatura_adresi') ? 'has-error' : '' }}">
