...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.hastaKategorileri.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.hasta-kategorileris.update", [$hastaKategorileri->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
