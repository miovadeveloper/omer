...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.receteler.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.recetelers.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('hasta_id') ? 'has-error' : '' }}">
